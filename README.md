...
## Amount of movies
To change amount of movies just go to ```MoviesApplicationInit``` and change ```idArray``` copy range (line 57). Should be 0 to how many you want, but more films requires more time.
